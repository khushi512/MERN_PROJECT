...
function ProfileRecruiter() {
    ...
    if (loading) {
        return (
            <>
                <NavBarRecruiter />
                <div className={`min-h-screen flex items-center justify-center font-semibold ${isDarkMode ? "bg-gray-900 text-gray-300" : "bg-gray-50 text-gray-600"
                    }`}>
                    Loading profile...
                </div>
            </>
    ...
    if (!user) {
        return (
            <>
                <NavBarRecruiter />
                <div className={`min-h-screen flex items-center justify-center ${isDarkMode ? "bg-gray-900 text-gray-300" : "bg-gray-50 text-gray-600"
                    }`}>
                    Profile not found.
                </div>
            </>
    ...
    return (
        <div className={`min-h-screen transition-colors ${isDarkMode ? "bg-gray-900" : "bg-gray-50"}`}>
            ...
            <button
                ...
                className={`fixed bottom-6 right-6 p-4 rounded-full shadow-lg z-40 transition-all hover:scale-110 ${isDarkMode
                ...
                <div className="w-full max-w-3xl">
                    ...
                    <div className={`rounded-2xl shadow-lg overflow-hidden ${isDarkMode ? "bg-gray-800" : "bg-white"
                        ...
                        <div className="px-8 pt-8 pb-6">
                            <div className="flex items-start gap-6">
                                ...
                                <div className="flex-shrink-0">
                                    {user.profilePic ? (
                                        <img
                                            ...
                                            alt={user.name}
                                            className={`h-24 w-24 rounded-full object-cover border-2 shadow-lg ${isDarkMode ? "border-gray-700" : "border-gray-200"
                                                }`}
                                        />
                                    ) : (
                                        <div className={`h-24 w-24 rounded-full flex items-center justify-center text-white text-3xl font-bold border-2 shadow-lg ${isDarkMode
                                ...
                                <div className="flex-1 min-w-0 pt-1">
                                    ...
                                    <div className={`flex flex-wrap items-center gap-2 text-base ${isDarkMode ? "text-gray-400" : "text-gray-600"
                                        }`}>
                        ...
                        <div className="px-8 mb-6">
                            <div className={`rounded-xl p-6 border ${isDarkMode
                                ...
                                <h3 className={`text-lg font-semibold mb-3 flex items-center gap-2 ${isDarkMode ? "text-cyan-400" : "text-cyan-600"
                                    }`}>
                                    📝 About
                                </h3>
                        ...
                        <div className="px-8 mb-6">
                            <div className={`rounded-xl p-6 border ${isDarkMode
                                ...
                                <h3 className={`text-lg font-semibold mb-4 flex items-center gap-2 ${isDarkMode ? "text-cyan-400" : "text-cyan-600"
                                    }`}>
                                    🏢 Company Details
                                </h3>
                        ...
                        <div className="flex justify-center px-8 pb-8">
                            <button
                                ...
                                className={`px-8 py-3 rounded-lg font-medium transition-all flex items-center gap-2 shadow-md hover:shadow-lg ${isDarkMode
                    ...
                    {isEditing && (
                        <div className="fixed inset-0 flex items-start justify-center bg-black/50 backdrop-blur-sm z-50 overflow-y-auto p-4">
                            <div className={`w-full max-w-xl rounded-2xl shadow-2xl my-8 ${isDarkMode ? "bg-gray-800" : "bg-white"
                                }`}>
                                {/* Modal Header - Sticky */}
                                <div className={`sticky top-0 z-10 flex justify-between items-center p-6 border-b rounded-t-2xl ${isDarkMode
                                    ...
                                    <button
                                        ...
                                        className={`hover:bg-gray-100 rounded-full p-2 transition ${isDarkMode ? "text-gray-400 hover:bg-gray-700" : "text-gray-500"
                                            }`}
                                    >
                                        <X size={24} />
                                    </button>
                                ...
                                <div className="max-h-[calc(100vh-280px)] overflow-y-auto">
                                    <div className="p-6">
                                        ...
                                        <div className="mb-6">
                                            <label className={`block text-sm font-semibold mb-3 ${isDarkMode ? "text-gray-200" : "text-gray-900"
                                                }`}>
                                                Profile Picture
                                            </label>
                                            <div className="flex items-center gap-4">
                                                <div className="relative">
                                                    {previewImage ? (
                                                        ...
                                                        <div className={`h-20 w-20 rounded-full flex items-center justify-center ${isDarkMode
                                        ...
                                        <div className="flex flex-col gap-4 pb-6">
                                            <div>
                                                <label className={`block text-sm font-semibold mb-2 ${isDarkMode ? "text-gray-200" : "text-gray-900"
                                                    }`}>
                                                    Full Name
                                                </label>
                                                <input
                                ...
                                <div className={`sticky bottom-0 flex justify-end gap-3 p-6 border-t shadow-lg ${isDarkMode
                                        ? "bg-gray-800 border-gray-700"
                                        : "bg-white border-gray-200"
                                    }`}>
                                    <button
                                        onClick={handleCancel}
                                        disabled={uploadingImage}
                                        className={`px-6 py-2 rounded-lg font-medium transition disabled:opacity-50 ${isDarkMode
