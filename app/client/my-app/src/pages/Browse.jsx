...
const Browse = () => {
  ...
  if (error) {
    return (
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-teal-400 via-cyan-500 to-sky-500">
        <Navbar />
        <div className="flex flex-1 items-center justify-center">
          <div className="bg-white shadow-md p-6 rounded-lg text-center text-red-500 font-semibold">
            {error}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-teal-400 via-cyan-500 to-sky-500">
      <Navbar />
                ...
                (job) =>
                  job && (
                    <div
                      ...
                      className="bg-white rounded-2xl shadow-lg p-6 flex flex-col justify-between hover:shadow-2xl hover:-translate-y-1 transition-all"
                    >
                      <div>
