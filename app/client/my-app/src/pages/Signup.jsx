              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 py-2 px-3 rounded-lg text-sm font-semibold transition border-2 ${userType === "applicant"
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 px-3 rounded-lg text-sm font-semibold transition border-2 ${userType === "recruiter"
                        ? "bg-gradient-to-r from-[#48c6ef] to-[#6f86d6] text-white border-[#48c6ef]"
                        : "bg-gray-50 text-gray-900 border-gray-300 hover:border-gray-400"
                      }`}
                    disabled={isLoading}
